...
from AKCN_Hybrid_prime_failure import *
...
if __name__ == "__main__":
    ...
    #     print("**************************************")
    #     print("AKCN_Hybrid_prime: n = %d, q = %d, p = 2^%d, g = 2^%d, eta1 = %d, eta2 = %d, eta = %d\n"%(ps_temp.n, ps_temp.q, log(ps_temp.p,2), log(ps_temp.g,2), ps_temp.eta, ps_temp.eta1, ps_temp.eta2))  
